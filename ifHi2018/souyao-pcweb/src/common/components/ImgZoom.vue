  ...
  export default {
    ...
    methods: {
      handMove(e) {
        ...
        let objY = e.pageY - (this.imgRect.top + document.body.scrollTop+document.documentElement.scrollTop);
      ...
      handOver(e) {
        if (!document.getElementById('_magnifier_layer')) {
          ...
          imgLayer.style.top = this.imgRect.top + document.body.scrollTop+document.documentElement.scrollTop - 2 + 'px';
